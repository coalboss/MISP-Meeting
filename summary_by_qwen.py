...
def clear_up_summary_json(summary_json):
    ...
    for key, value in summary_dict.items():
        ...
        detailed_summary = summary_list[0][1].strip().replace('（800-1100字）', '')
        summary_dict[key] = {
            'brief': brief_summary,
            'detail': detailed_summary
        }
...
if __name__ == '__main__':
    ...
    main_summarize(
        data_json='/disk3/hangchen/data/misp-meeting/eval/recognition_CSOBx3_by_whisper_large-v3_meeting.json', 
